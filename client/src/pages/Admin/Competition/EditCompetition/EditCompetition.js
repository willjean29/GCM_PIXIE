...
const EditCompetition = ({ competition }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      soles: Yup.number("Ingrese un número valido")
        .required("La cantidad en soles es obligatoria")
        .min(1, "Ingrese una cantida valida"),
      puntos: Yup.number("Ingrese un número valido")
        .required("La cantidad de puntos es obligatoria")
        .min(1, "Ingrese una cantida valida"),
