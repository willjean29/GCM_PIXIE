...
import { imagenClienteAction } from "../../../../../redux/actions/clientActions";
import NoAvatar from "../../../../../assets/img/png/no-avatar.png";
import "./Logo.scss";
const Logo = () => {
  const dispatch = useDispatch();
  const avatarClient = (dataImage) => dispatch(imagenClienteAction(dataImage));
  ...
  return (
    <Card type="inner" title="Agregar foto" className="logo-profile" hoverable>
